...
def generate_sample_referee_data(count: int, competition_name: str = "Competition") -> List[Dict]:
    ...
    first_names = ["John", "Sarah", "Mike", "Emma", "David", "Lisa", "James", "Maria", "Robert", "Jennifer"]
    ...
    for i in range(count):
        ...
        referee_data = {
            ...
            'email': sample_emails[i] if i < len(sample_emails) else f"referee{i+1}@competition.com",
